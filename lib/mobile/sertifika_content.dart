...
class SertifikaContentMobile extends StatefulWidget {
  final String id;
  const SertifikaContentMobile({super.key, required this.id});

  @override
  State<SertifikaContentMobile> createState() => _SertifikaContentMobileState();
}

class _SertifikaContentMobileState extends State<SertifikaContentMobile> {
  String name = "...";
  String no = "...";
  String profilePhoto = "...";
  String getID = "...";
